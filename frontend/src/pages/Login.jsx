...
function Login() {
  ...
  const handleAdminSignIn = async (e) => {
    ...
    try {
      ...
      setAdminError(error.response?.data?.detail || 'Invalid email or password')
    } finally {
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4 py-12">
      <div className="w-full max-w-[400px] space-y-8">
        ...
        <div className="space-y-2 text-center">
          <h1 className="text-2xl font-semibold tracking-tight">Sign in to Arka</h1>
          <p className="text-sm text-muted-foreground">Connect to your MCP servers securely</p>
        </div>
